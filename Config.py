...
def cfg():
    ...
    model_config = {'num_layers' : 12, # How many U-Net layers
                    'filter_size' : 14, # For Wave-U-Net: Filter size of conv in downsampling block
                    'merge_filter_size' : 5, # For Wave-U-Net: Filter size of conv in upsampling block
                    'input_filter_size' : 14, # For Wave-U-Net: Filter size of first convolution in first downsampling block
                    ...
                    'max_samples_per_song': 160, # NOTE TO SELF -- max for (20, 10, 4, 5) for testing
                    'num_init_filters': 14, # 
